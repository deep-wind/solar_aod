...
if st.button("Predict"):
    ...
    if data[x,y]==fillvalue:
		st.markdown("<h1 style='text-align: left; font-weight:bold;color:black;background-color:white;font-size:11pt;'> The value of {SDS_NAME} at this pixel is {fillvalue} (No Value) </h1>",unsafe_allow_html=True)
