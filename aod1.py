...
st.markdown("<h1 style ='color:DarkGreen; text_align:center;font-family:times new roman;font-weight: bold;font-size:20pt;background-color:white;'>Impact of Aerosols in Solar Power Generation </h1>", unsafe_allow_html=True)  
...
st.markdown("<h5 style ='color:darkblue; text_align:center;font-family:times new roman;font-weight: bold;font-size:13pt;'>Please enter the latitude (between 14.599766 to 35.4595 degrees) (Deg. N):  </h5>", unsafe_allow_html=True)  
